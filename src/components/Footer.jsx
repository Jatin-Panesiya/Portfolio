        ...
        <div className="w-full bg-gradient-to-b from-gray-800 via-gray-800 to-black">
            ...
            <div className="max-w-6xl mx-auto  py-10 px-20 grid grid-col-1 gap-10 sm:gap-3  sm:grid-cols-2 lg:grid-cols-3 text-white">
                ...
                <div className='grid gap-2'>
                    ...
                    <a href='https://www.instagram.com/panesiya_jatin/' rel="noreferrer" target='_blank' className="hover:underline cursor-pointer text-slate-300 text-lg">Instagram</a>
                    <a href='https://in.linkedin.com/in/jatin-panesiya'rel="noreferrer" target='_blank' className="hover:underline cursor-pointer text-slate-300 text-lg">Linkdein</a>
                    <a href='https://github.com/Jatin-Panesiya' rel="noreferrer" target='_blank' className="hover:underline cursor-pointer text-slate-300 text-lg">Github</a>
